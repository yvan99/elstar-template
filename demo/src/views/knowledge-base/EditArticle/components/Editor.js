...
import { Input, FormItem, FormContainer, Select, Button, Notification, toast } from 'components/ui'
...
const Editor = ({mode}) => {
	...
	useEffect(() => {
		if(!categoryList.some(cat => cat.id === categoryValue) && categoryLabel && categoryValue) {
						...
						(
							<FormContainer>
								...
								<div className="mt-4 flex justify-end">
									<Button loading={isSubmitting} variant="solid">Submit</Button>				
								</div>
							</FormContainer>
						)
					}
