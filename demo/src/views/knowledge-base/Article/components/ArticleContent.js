...
import { Loading, UsersAvatarGroup, MediaSkeleton, TextBlockSkeleton } from 'components/shared'
...
const ArticleContent = ({ articleId }) => {
	...
	const article = useSelector((state) => state.knowledgeBaseArticle.data.article)
	const loading = useSelector((state) => state.knowledgeBaseArticle.data.loading)
	...
	return (
		...
		>
			...
			<div className="flex items-center mt-4 gap-4">
				<UsersAvatarGroup avatarProps={{size: 40}} users={article.authors || []} />
