...
const reactQuillApi = (
	<div className="demo-api-table mb-12">
		...
		<h6 id="react-syntax-highlighter-api" className="mb-3">react-quill</h6>
		<p>All react-quill props can be applied on this component, refer <a className="underline text-indigo-600" href="https://github.com/zenoamaro/react-quill#props" target="_blank" rel="noreferrer">official docs</a> for the complete api list. </p>
	</div>
)
