...
const reactSyntaxHighlighterApi = (
	<div className="demo-api-table mb-12">
		...
		<h6 id="react-syntax-highlighter-api" className="mb-3">react-syntax-highlighter</h6>
		<p>All react-syntax-highlighter props can be applied on this component, refer <a className="underline text-indigo-600" href="https://github.com/react-syntax-highlighter/react-syntax-highlighter#props" target="_blank" rel="noreferrer">official docs</a> for the complete api list. </p>
	</div>
)
