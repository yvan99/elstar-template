...
const demoApi = [
	{
		...
		api: [
			{
				propName: 'columns',
				type: `<a class="text-indigo-600 underline" href="https://react-table-v7.tanstack.com/docs/api/useTable#column-options" target="_blank"><code>Array&lt;Column&gt;</code></a>`,
				default: `<code>[]</code>`,
			...
			{
				propName: 'onSort',
				type: `<code>(pageSize: {order: 'desc' | 'asc', key: string}, sortedColumn: {id: string, clearSortBy: () => void}) => void</code>`,
				default: `-`,
			...
			{
				propName: 'autoResetSelectedRows',
				type: `<code>boolean</code>`,
				default: `<code>true</code>`,
				desc: 'When true, the selectedRowIds state will automatically reset if data is changed'
			}
		]
	}
]
