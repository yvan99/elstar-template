...
const reactFullCalendarApi = (
	<div className="demo-api-table mb-12">
		...
		<h6 id="react-syntax-highlighter-api" className="mb-3">Fullcalendar</h6>
		<p>All fullcalendar props can be applied on this component, refer <a className="underline text-indigo-600" href="https://fullcalendar.io/docs/react#props" target="_blank" rel="noreferrer">official docs</a> for the complete api list. </p>
	</div>
)
