...
const reactSelectApi = (
	<div className="demo-api-table mb-12">
		...
		<h6 id="react-select-api" className="mb-3">React Select</h6>
		<p className="mb-1"><code>Select</code> is a wrapper component of <a className="underline text-blue-500" href="https://react-select.com/home" target="_blank" rel="noreferrer">react-select</a>.</p>
		<p>All react-select props can be applied on this component, refer <a className="underline text-blue-500" href="https://react-select.com/props" target="_blank" rel="noreferrer">official docs</a> for the complete api list. </p>
	</div>
)

const Select = () => {
	return (
		<DemoLayout header={demoHeader} demos={demos} api={demoApi} extra={reactSelectApi} />
	)
}
