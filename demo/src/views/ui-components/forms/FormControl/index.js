...
const mdPath = 'forms/FormControl/'
...
const formikNote = (
	<div>
		<h4>Formik</h4>
		<p className="mt-2">
			Formik is a flexible form library for React, which allow us to do form state manipulation, validation & submission, 
			you can visit the official 
			<a className="underline text-blue-500" href="https://formik.org/docs/overview" target="_blank" rel="noreferrer"> documentation </a>
		...
		<p className="mt-2">
			...
			you can visit the official 
			<a className="underline text-blue-500" href="https://github.com/jquense/yup" target="_blank" rel="noreferrer"> documentation </a>
...
const FormControl = () => {
	return (
		<DemoLayout header={demoHeader} demos={demos} api={demoApi} note={formikNote} />
	)
}
