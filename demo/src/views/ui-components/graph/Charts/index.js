...
const Extra = () => {
	return (
		<>
			...
			<p>
				There are several other charts which can be created by changing a couple of options. The major configuration has to be done in the <code>options</code> property of ApexCharts component and rest will fall into places. Refer to: 
				<a className="text-blue-500 hover:underline" href="https://apexcharts.com/react-chart-demos/" target="_blank" rel="noreferrer">
...
const Charts = () => {
	return (
		<DemoLayout header={demoHeader} demos={demos} api={demoApi} extra={<Extra />} />
	)
}
