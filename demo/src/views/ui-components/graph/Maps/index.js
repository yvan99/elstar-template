...
const Extra = () => {
	return (
		<>
			...
			<p>Read the <a target="_blank" href="https://www.react-simple-maps.io/docs/getting-started/" rel="noreferrer">docs</a>, or check out the <a target="_blank" href="https://www.react-simple-maps.io/examples/" rel="noreferrer">examples</a>.</p>
		</>
	)
}
