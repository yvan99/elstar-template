...
const mdPath = 'navigation/Dropdown/'
...
const demos = [
	...
	},
	{
		...
		mdPath: mdPath,
		title: 'Submenu',
		desc: `Dropdown acn also have multiple levels.`,
		component: <Submenu />
	},
	{
		mdName: 'Placement',
...
const demoApi = [
	...
	},
	{
		...
		api: [
			...
			{
				propName: 'variant',
				type: `<code>'default'</code> | <code>'header'</code> | <code>'divider'</code> | <code>'default'</code>`,
				default: `-`,
