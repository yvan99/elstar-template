			...
			<Table className="demo-api-table mb-8">
				...
				<TBody>
					...
					<Tr>
						...
						<Td><code>'top-start'</code> | <code>'top-center'</code> | <code>'top-end'</code> | <code>'bottom-start'</code> | <code>'bottom-center'</code> | <code>'bottom-end'</code></Td>
						<Td><code>'top-end'</code></Td>
					</Tr>
					<Tr>
						<Td className="font-semibold">transitionType</Td>
						<Td>Transition type of animation</Td>
						<Td><code>'scale'</code> | <code>'fade'</code></Td>
...
const Noification = () => {
	return (
		<DemoLayout header={demoHeader} demos={demos} api={demoApi} note={toastApi} hideApiTitle={true} />
	)
}
