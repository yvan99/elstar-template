...
const mdPath = 'data-display/Table/'
...
const demoApi = [
	...
	},
	{
		...
		api: [
			{
				propName: 'sort',
				type: `<code>boolean</code> | <code>undefined</code>`,
				default: `<code>'td'</code>`,
				desc: 'Sort status'
			}
		]
...
const reactTableApi = (
	<div className="demo-api-table mb-12">
		...
		<h6 id="react-table-api" className="mb-3">React Table</h6>
		<p className="mb-1">Most of the examples above were integrated with <code>react-table</code>, its is lightweight and extensible data table component for materialize, filter, sort, group, aggregate, paginate and display massive data. Vist the <a className="underline text-blue-500" href="https://react-table.tanstack.com/docs/overview" target="_blank" rel="noopener noreferrer">official docs</a> for futher examples & hooks usage.</p>
	</div>
)

const Table = () => {
	return (
		<DemoLayout header={demoHeader} demos={demos} api={demoApi} extra={reactTableApi} />
	)
}
