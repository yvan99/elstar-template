...
const uiComponentsRoute = [
    {
        ...
        component: React.lazy(() => import('views/ui-components/common/Button')),
    ...
    },
    {
        ...
        component: React.lazy(() => import('views/ui-components/common/Typography')),
        authority: [ADMIN, USER],
    },
    {
    ...
    },
    {
        ...
        component: React.lazy(() => import('views/ui-components/forms/InputGroup')),
        authority: [ADMIN, USER],
    },
    {
    ...
    },
    {
        ...
        component: React.lazy(() => import('views/ui-components/forms/Segment')),
        authority: [ADMIN, USER],
    },
    {
    ...
    },
    {
        ...
        component: React.lazy(() => import('views/ui-components/forms/Switcher')),
        authority: [ADMIN, USER],
    },
    {
        key: 'uiComponent.forms.timeInput',
        path: `${UI_COMPONENTS_PREFIX_PATH}/time-input`,
        component: React.lazy(() => import('views/ui-components/forms/TimeInput')),
        authority: [ADMIN, USER],
    },
    {
    ...
    },
    {
        ...
        component: React.lazy(() => import('views/ui-components/navigation/Dropdown')),
        authority: [ADMIN, USER],
    },
    {
        key: 'uiComponent.navigation.menu',
        path: `${UI_COMPONENTS_PREFIX_PATH}/menu`,
        component: React.lazy(() => import('views/ui-components/navigation/Menu')),
        authority: [ADMIN, USER],
    },
    {
        key: 'uiComponent.navigation.pagination',
        path: `${UI_COMPONENTS_PREFIX_PATH}/pagination`,
        component: React.lazy(() => import('views/ui-components/navigation/Pagination')),
        authority: [ADMIN, USER],
    },
    {
        key: 'uiComponent.navigation.steps',
        path: `${UI_COMPONENTS_PREFIX_PATH}/steps`,
        component: React.lazy(() => import('views/ui-components/navigation/Steps')),
        authority: [ADMIN, USER],
    },
    {
        key: 'uiComponent.navigation.tabs',
        path: `${UI_COMPONENTS_PREFIX_PATH}/tabs`,
        component: React.lazy(() => import('views/ui-components/navigation/Tabs')),
        authority: [ADMIN, USER],
    },
    {
